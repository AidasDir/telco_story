...
Launch 2nd
```bash
sudo docker run -it --privileged --user root --cap-add ALL  -v /dev/bus/usb:/dev/bus/usb bastienbaranoff/evil_bts:latest
```
...
OpenBSC# subscriber extension 32975 a3a8 comp128v1 000102030405060708090a0b0c0d0e0f
